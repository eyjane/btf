...
public class AddRawMaterial extends javax.swing.JFrame {
    ...
    public AddRawMaterial(RMManagement r) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
   ...
   public boolean authenticateRM(){
    ...
    private void initComponents() {
        ...
        addRawMaterial.setText("Add Raw Material");
